...
import { createRecipe } from "../config/services.config"
import { getAllRecipes } from "../config/services.config"
import { getRecipeById } from "../config/services.config"
import { updateRecipe } from "../config/services.config"
import { deleteRecipe } from "../config/services.config"
import { getRecipeBySlug } from "../config/services.config"
import { rateRecipe } from "../config/services.config"
import { getRecipeRatings } from "../config/services.config"
import { removeRecipeRating } from "../config/services.config"
